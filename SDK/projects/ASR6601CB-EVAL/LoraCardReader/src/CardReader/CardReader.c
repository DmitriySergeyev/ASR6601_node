 ...
 * The interface is described in the datasheet section 8.1.2.
 */
void PCD_WriteRegisterEx(	uint8_t reg,		///< The register to write to. One of the PCD_Register enums.
 ...
 * The interface is described in the datasheet section 8.1.2.
 */
void PCD_ReadRegisterEx(	uint8_t reg,		///< The register to read from. One of the PCD_Register enums.
...
uint8_t PCD_CalculateCRC(	uint8_t *data,		///< In: Pointer to the data to transfer to the FIFO for CRC calculation.
	...
	PCD_WriteRegisterEx(FIFODataReg, length, data);	// Write data to the FIFO
...
bool PCD_PerformSelfTest() {
	...
	PCD_WriteRegisterEx(FIFODataReg, 25, ZEROES);	// write 25 uint8_ts of 00h to FIFO
	...
	uint8_t result[64];
	PCD_ReadRegisterEx(FIFODataReg, 64, result, 0);
